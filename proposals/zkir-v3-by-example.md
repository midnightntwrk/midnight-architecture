...
A possible change for ZKIR version 3 is to change the implicit outputs indexes into explicit output names.
...
In the JSON representation, a string is a named instruction output and a number is an immediate field value.

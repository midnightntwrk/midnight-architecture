...
1. Usability - it should resemble a well-known programming paradigm
2. Leveragability - it should should enable reusing public computations (functions)
3. Expressability - it should should provide a non-circuit and non-private oracle mechanism for iterative computation (loops/folds)

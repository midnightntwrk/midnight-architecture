...
open import Util.Functor 
open import Util.Ternary as Ternary
...
-- instances defined in Util.Functor.
module Util.MonotonePredicate {c ℓ}
  (Carrier : Set c)
...
-- connectives defined in Util.Logic,

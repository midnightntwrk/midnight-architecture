...
```agda 
    [stmt-foreach] : ( E₁ : ⟨ 𝓒 ∣ Γ ⟩⊢expr Vector[ #n , T′ ] )
                   → ( S  : ⟨ 𝓒 ∣ T′ ∷ Γ ⟩⊢stmt T ⊣ Γ′ )
                     -----------------------------------
                   → ⟨ 𝓒 ∣ Γ ⟩⊢stmt T ⊣ Γ 
```
...
```agda 
    [stmt-ifelse]  : ( E  : ⟨ 𝓒 ∣ Γ ⟩⊢expr Boolean )
                   → ( S₁ : ⟨ 𝓒 ∣ Γ ⟩⊢stmt T ⊣ Γ₁ )
                   → ( S₂ : ⟨ 𝓒 ∣ Γ ⟩⊢stmt T ⊣ Γ₂ )
                     -------------------------------
                   → ⟨ 𝓒 ∣ Γ ⟩⊢stmt T ⊣ Γ
...
```agda 
    [stmt-assert]  : ( E    : ⟨ 𝓒 ∣ Γ ⟩⊢expr Boolean )
                   → ( msg : String )
                     ---------------------------------
                   → ⟨ 𝓒 ∣ Γ ⟩⊢stmt T ⊣ Γ
``` 

...
2. To seperate Midnight Ledger from runtime through native runtime interface (current state)
...
* to separate Midnight Ledger from runtime through native runtime interface
...
* There are still possibilities to explore alternative options in the future
...
* Relatively little amount of prearational work in components participating in consensus
...
* without client components needed to be updated after upgrade was performed
